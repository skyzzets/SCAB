...
var CarDetailsList = [];
CarDetailsList.push(new CarDetails('Huracán', 'Lamborghini', '2021/2022', 'R$ 5.499,00', 'Automatica', 'Branco', 'São Paulo', '1.100 km', '4x2', 'A Lamborghini Huracán personifica a união perfeita entre elegância e desempenho. Seu design escultural e linhas aerodinâmicas sugerem velocidade, enquanto o potente motor V10 proporciona uma experiência de condução visceral. No interior, materiais luxuosos e tecnologia de ponta garantem conforto e sofisticação. Uma obra-prima automotiva que transcende as expectativas, cada detalhe da Huracán é meticulosamente projetado para cativar e inspirar.', 'Trocar depois', 'resources/Storage/AudiA6.jpeg'));
CarDetailsList.push(new CarDetails('Gallardo', 'Lamborghini', '2010', 'R$ 1.149,99', 'Automatica', 'Branco', 'São Paulo', '18.000 km', '4x2', 'A Lamborghini Gallardo, um ícone de elegância e potência, combina linhas aerodinâmicas sofisticadas com um desempenho excepcional. Seu motor V10 proporciona uma experiência de condução emocionante, enquanto o interior refinado e luxuoso envolve os ocupantes em um ambiente de conforto e estilo. Uma síntese perfeita entre forma e função, a Gallardo é uma obra-prima que transcende a simples definição de carro esportivo.', 'Trocar depois', 'resources/Storage/AudiA6.jpeg'));
...
function showCarDetails(name){
    ...
    let elementCarDetails = `
        <div class="card animate__animated animate__fadeInUp">
            <img class="card-img-top card-details-img-height common-img-fluid" src="${elementCar.image}"  alt="${elementCar.name}"/>
            <div class="card-body">
