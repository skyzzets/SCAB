...
CarDetailsList.push(new CarDetails('Cayman GTS', 'Porsche', '2016', 'R$ 879,90', 'Automatica', 'Vermelho', 'São Paulo', '4.925', 'Traseira', 'O Porsche Cayman 3.4 GTS, com seu motor I6 de 24V, é uma sinfonia de potência e elegância. Seu design atemporal e linhas aerodinâmicas refletem sofisticação, enquanto o desempenho excepcional oferece uma experiência de condução emocionante. No interior, materiais premium e tecnologia se combinam para criar um ambiente luxuoso e envolvente. Este automóvel é uma obra-prima da engenharia que equilibra magistralmente performance e estilo refinado.', '3.4 GTS I6 24V GASOLINA 2P AUTOMÁTICO', 'resources/Storage/Porsche/CaymanGTS.jpg'));
...
CarDetailsList.push(new CarDetails('Gemera', 'Koenigsegg', '2025', 'R$ 20.000.00,00', 'LSTT', 'Nardo Gray', 'Suécia - São Paulo', '0', 'Integral', 'Como um Mega-GT e o primeiro quatro lugares da Koenigsegg, o Gemera representa uma nova categoria de veículo revolucionária com um design automotivo inovador a condizer. A silhueta do Gemera é longa, elegante e minimalista, mantendo a estética icônica da Koenigsegg. ', 'Hybrid HV8 LSTT Dark Matter', 'resources/Storage/Koenigsegg/Gemera.jpg'));
